...
export class Backend implements backendInterface {
    ...
    async getAllPicks(): Promise<Array<StockPick>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllPicks();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getBreakingNewsTrades(): Promise<Array<BreakingNewsTrade>> {
        if (this.processError) {
            try {
                const result = await this.actor.getBreakingNewsTrades();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getScanMetadata(): Promise<ScanMetadata> {
        if (this.processError) {
            try {
                const result = await this.actor.getScanMetadata();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTopPicks(): Promise<Array<StockPick>> {
        if (this.processError) {
            try {
    ...
    async triggerManualScan(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.triggerManualScan();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
